...
class FireSmokeInference(BaseInference):
    def __init__(self):
        self.classes = {
            0: "fire",
            1: "smoke",
...
class NeuralNetworkInference(FireSmokeInference):
    """
    ...
    def __init__(
        ...
        # Initialise the self.classes and self.out_data attributes
        super(NeuralNetworkInference, self).__init__()
...
class MLInference(FireSmokeInference):
    def __init__(
            self,
            model_path: str,
            data_colour_space: str,
        ...
        if not self.model_path.endswith(".onnx"):
            raise TypeError("Only supports onnx models at the moment.")
        self.data_colour_space = data_colour_space
        self.roi_out_path = roi_out_path
        self.model_inference_params_path = model_inference_params_path
        self.csv_out_dir = csv_out_dir
